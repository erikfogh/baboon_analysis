...
# Paths to files
idfile = "/home/eriks/baboondiversity/data/PG_panu3_phased_chromosomes_4_7_2021/included_females.ids"
phasefile = "/home/eriks/baboondiversity/data/PG_panu3_phased_chromosomes_4_7_2021/chr{}/chr{}.filtered.females.phase"
recombfile = "/home/eriks/baboondiversity/data/PG_panu3_phased_chromosomes_4_7_2021/chr{}/chr{}.filtered.females.recombfile"
...
def globetrotter_run1(pop_dir, globetrotter, chr_list, paramfile, outname):
    ...
    options = {'cores': 6, 'memory': "10g", 'walltime': "12:00:00", "account": 'baboondiversity'}
    spec = """
    cd {pop_dir}
...
def param_samples_creator(template_param, chr_list, idfile, pop_dir, s_list, target_pop, recom_file, name):
    ...
    lines[10] = lines[10].split(" ")[0]+" 2\n"
    lines[11] = lines[11].split(" ")[0]+" 0.025\n"
    lines[15] = lines[15].split(" ")[0]+" 0.8 50\n"
